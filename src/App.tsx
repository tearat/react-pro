    ...
    <div className="wrapper">
      <div className={s.block}>
        ...
        <div className={s.body}>
          <p className={s.body__line}>
            <span className="accent">#1</span>: {example.concat('Hello', 'world')}
          </p>
          <p className={s.body__line}>
            <span className="accent">#2</span>: {example.myHometask.howIDoIt}
          </p>
          <p className={s.body__line}>
            <span className="accent">#3</span>: {example.summ}
          </p>
